...
**単体テスト**: `backend/test/unit/`配下にsrcと同じ構造で配置
...
**統合テスト**: `backend/test/integration/`に配置
...
- 単体: `backend/test/unit/services/UserService.test.ts`
- 統合: `backend/test/integration/userAuth.int.test.ts`

**Frontend配置例**:
- 実装: `frontend/src/components/UserProfile.tsx`
- 単体: `frontend/test/unit/components/UserProfile.test.tsx`
- 統合: `frontend/test/integration/userProfile.int.test.tsx`

**補足**: frontendもbackendと同じディレクトリ構造を使用します
- 単体テスト: `frontend/test/unit/`配下にsrcと同じ構造で配置
- 統合テスト: `frontend/test/integration/`に機能名で配置
