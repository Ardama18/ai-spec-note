...
sub-agents.md（~/.claude/plugins/marketplaces/ai-spec-driven-framework/steering/sub-agents.md） を厳守し、オーケストレーターとして振る舞います。
...
⚠️ **特にtask-executorは自律実行モードでクラッシュリスクが高いため、プロンプト末尾に配置**
