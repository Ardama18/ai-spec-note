...
**入力**: タスクファイルパス（例: `specs/plans/tasks/F001-user-profile-tasks-001.md`）

**処理フロー**:
1. **タスクファイルを読み込み**、以下を抽出:
   - **メタ情報「依存」**: `Figma cache: specs/design-cache/[ID]-[feature]/` を取得
...
- ~/.claude/plugins/marketplaces/ai-spec-driven-framework/steering/ui-design-integration.md - UIデザイン統合ルール（キャッシュ構造、データ抽出、検証基準）
...
CACHE_DIR="specs/design-cache/F001-user-profile/"
...
~/.claude/plugins/marketplaces/ai-spec-driven-framework/steering/ui-design-integration.md に従ってデータを抽出：
