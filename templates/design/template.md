...
version: 1.0.0
created: [YYYY-MM-DD]
based_on: specs/requirements/[ID]-[機能名]-requirements.md
---
...
**Figmaデータソース**: `specs/design-cache/[ID]-[機能名]/outline.json` または `components/[Screen].json`
...
**Figmaキャッシュディレクトリ**: `specs/design-cache/[ID]-[機能名]/`
...
**データソース**: `specs/design-cache/[ID]-[機能名]/variables.json`
...
**Figmaデータソース**: `specs/design-cache/[ID]-[機能名]/components/[ComponentName].json`
